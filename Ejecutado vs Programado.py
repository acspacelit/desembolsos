...
def load_data():
    base_path = "data"
    path_operaciones = os.path.join(base_path, "Operaciones.xlsx")
    path_proyecciones_iniciales = os.path.join(base_path, "Proyeccionesiniciales.xlsx")
    path_proyecciones = os.path.join(base_path, "Programado.xlsx")

    data_operaciones = pd.read_excel(path_operaciones, parse_dates=['FechaEfectiva'])
    data_proyecciones_iniciales = pd.read_excel(path_proyecciones_iniciales, parse_dates=['FechaProgramada'])
    data_proyecciones = pd.read_excel(path_proyecciones, parse_dates=['Fecha'])

    # Aquí se realiza el mismo procesamiento que el código original para CSV
